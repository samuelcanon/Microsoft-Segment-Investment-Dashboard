...
Microsoft reports one operating margin. In FY2024 it was 44.6%, making it look stable. Look closer, the fastest growing segment is not the most profitable one, which makes the next place to allocate money to become unclear. That is why this ends in three different recommendations rather than one.
